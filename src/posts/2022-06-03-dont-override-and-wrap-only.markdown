...
<h3 class="text-lg">Wrong solution</h3>
...
But recently <a class="link" href="https://nix.how">Matthew</a> made me aware that my approach causes compilation of the wrapped executable (`demo`) to occur twice under certain circumstances.
...
<h3 class="text-lg">Better solution</h3>
...
I would like to thank <a class="link" href="https://nix.how">Matthew</a> for taking his time to explain me this subtle issue.
